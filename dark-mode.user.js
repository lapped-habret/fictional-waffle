...
var mapValues = __webpack_require__(33);
...
var some = __webpack_require__(34);
...
function cssRuleMatchesSwap(rule, swap) {
    // @ts-ignore
    var match = some_default()(swap.initial, function (i) {
        //@ts-ignore
        return rule.style && rule.style[swap.prop] === i;
    });
    var selectorMatch = swap.selectorTexts && some_default()(swap.selectorTexts, function (i) {
...
function applyTheme(theme) {
    ...
    each_default()(keys_default()(theme.props).concat(['misc']), function (themeProp) {
...
function applyThemeProperty(theme, themeProp, themeValue) {
    ...
    each_default()(ruleSwaps, function (swap) {
        each_default()(swap.matchedStyleRules, function (rule) {
            if (swap.transform) {
...
function getMatchedStyleRules(swap, styleSheet) {
    ...
    //@ts-ignore
    each_default()(cssRules, function (rule) {
...
function addRuleSwaps(styleSheet) {
    // @ts-ignore
    mapValues_default()(window.googleChatThemesRuleSwapList, function (swaps) {
        return map_default()(swaps, function (swap) {
...
function initializeRuleSwapList() {
    const ruleSwapList = mapValues_default()(src_ruleSwaps, function (swaps) {
        return map_default()(swaps, function (swap) {
...
function getStyleSheetSignature(styleSheet) {
    ...
    return map_default()(cssRules, function (rule) {
...
function onStyleSheetLoaded(cb) {
    ...
    function checkLoaded() {
        each_default()(range_default()(1, document.styleSheets.length), function (index) {
...
var arrayMap = __webpack_require__(64),
    ...
    baseMap = __webpack_require__(151),
...
var arrayEach = __webpack_require__(66),
    ...
    castFunction = __webpack_require__(79),
    isArray = __webpack_require__(1);
...
/* harmony import */ var _ops__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(9);
/* harmony import */ var _themes_dark__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(14);
...
function main() {
    ...
    Object(_ops__WEBPACK_IMPORTED_MODULE_0__[/* onStyleSheetLoaded */ "f"])(function (styleSheet) {
        ...
        Object(_ops__WEBPACK_IMPORTED_MODULE_0__[/* applyTheme */ "c"])(_themes_dark__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"]);
    });
}
window.onload = main;
